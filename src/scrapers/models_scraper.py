...
def merge_brand_models(dict1, dict2):
    ...
    Args:
        dict1 (dict), dict2 (dict): Dictionaries of brands and their models.

    Returns:
        dict: Merged dictionary of brands and their models.
    """
...
def run_models_scraper():
    """
    Run the models scraper for Ivory and KSP, merge the results, and export to JSON.
    """
    try:
